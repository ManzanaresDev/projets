...
export default function CreateCoursePage() {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // pour spinner lors de la création
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage("✅ Course creation successfully !");
      setTitle("");
      setDescription("");
      setFile(null);
      setLogo(null);
      ...
      <div className="admin-dashboard grid">
        ...
        <div className="left-panel">
          ...
          >
            ...
            <button
              type="submit"
              className="admin-button blue small"
            ...
            {isSubmitting && (
              <div className="loading-container">
                <p>Création du cours en cours...</p>
              </div>
            )}
